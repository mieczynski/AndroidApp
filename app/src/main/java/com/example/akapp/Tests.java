...
public class Tests {
    public static void DoubleLinkedListTest(int sizeOfStructure, int countOfTests, TextView text) {
        long startTime;
        long endTime;
        long duration;
        ...
        txt = "-------DoubleLinkedList-------\n"+"Dodawanie w wybrane miejsce: " + (averageOfAdd / countOfTests) + " ns\n" + "Dodawanie na koniec: "
                + (averageOfAdd_End / countOfTests) + " ns\n" + "Usuniecie z wybranego miejsca " +
                (averageOfRemove/ countOfTests) + " ns\n" +"---------------------\n";
text.setText(txt);
    }
    public static void DynamicArrayTest(int sizeOfStructure, int countOfTests, TextView text) {
        long startTime;
        long endTime;
        long duration;
        double averageOfAdd = 0;
        ...
        txt = "-------DynamicArray-------\n"+"Dodawanie w wybrane miejsce: " + (averageOfAdd / countOfTests) + " ns\n" + "Dodawanie na koniec: "
                + (averageOfAdd_End / countOfTests) + " ns\n" + "Usuniecie z wybranego miejsca " +
                (averageOfPopIndex/ countOfTests) + " ns\n"+ "Usuniecie z końca " +
                (averageOfPop/ countOfTests) + " ns\n" + "---------------------\n";
        text.setText(txt);

    }

    public static void TreeTest(int sizeOfStructure, int countOfTests, TextView text) {
        long startTime;
        long endTime;
        long duration;
        double averageOfAdd = 0;
        ...
        txt ="-------Tree-------\n"+ "Dodawanie w wybrane miejsce: " + (averageOfAdd / countOfTests) + " ns\n"
                + "Usuniecie z wybranego miejsca " + (averageOfRemove/ countOfTests) + " ns\n" +
        "------------------------------";
        text.setText(txt);
